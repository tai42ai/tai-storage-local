"""The local-filesystem :class:`~tai_contract.storage.Storage` backend.
...
a stateless :class:`~tai_storage_local.driver.AsyncLocalDriver` from the cached
...
Registering the class fires ``@tai_app.storage.register_storage`` as an import
